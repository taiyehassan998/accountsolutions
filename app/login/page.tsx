...
<h2 style={{fontSize:'24px',fontWeight:900}}>Login</h2>
<p style={{color:'#6b7f7d',fontSize:'13px',marginBottom:'16px'}}>Welcome back to Account Solutions Hub</p>
...
<button style={{width:'100%',padding:'12px',background:'linear-gradient(90deg, #0e8a7a, #0a7ad1)',color:'white',borderRadius:'999px',border:'none',marginTop:'12px',fontWeight:700}}>Login</button>
<p style={{textAlign:'center',marginTop:'14px',fontSize:'13px'}}>No account? <a href="/signup" style={{color:'#0a7ad1',fontWeight:700}}>Sign Up</a></p>
